...
- (void)emailMe {
    if (![MFMailComposeViewController canSendMail]) {
        self.title = @"earlhoratio@gmail.com";
        UIPasteboard *pasteboard = [UIPasteboard generalPasteboard];
        pasteboard.string = @"earlhoratio@gmail.com";
        return;
    }
    
    MFMailComposeViewController *mailComposeVC = [MFMailComposeViewController new];
    [mailComposeVC setToRecipients:@[@"earlhoratio@gmail.com"]];
...
- (void)share {
    ...
    UIImage *image = [UIImage imageNamed:@"SecretLogo"];
    NSURL *URL = [NSURL URLWithString:@"https://github.com/summit1206/KeepSecret"];
